            ...
            <main className="container mx-auto flex-1 p-4 sm:p-8">
                <div className="mx-auto flex flex-col sm:flex-row rounded-lg bg-white p-4 sm:p-8">
                    ...
                    <div className="w-full sm:w-1/2 pl-0 sm:pl-8 items-center">
                        ...
                        <textarea id="message" rows={4} className="block p-2.5 w-72 text-sm text-gray-900 bg-gray-50 rounded-lg border border-cyan-500 focus:ring-cyan-500 focus:border-cyan-500 mb-3 max-w-80 mx-2" placeholder="Option"></textarea>
