...
const orders = [
    { name: 'Humberger', quantity: 1, status: 'Ready', price: '2000 Ks' },
    { name: 'Humberger', quantity: 2, status: 'Preparing', price: '2000 Ks' },
    { name: 'Humberger', quantity: 3, status: 'Ready', price: '2000 Ks' },
    { name: 'Humberger', quantity: 4, status: 'Served', price: '2000 Ks' },
    { name: 'Humberger', quantity: 5, status: 'Preparing', price: '2000 Ks' },
    { name: 'Humberger', quantity: 6, status: 'Ready', price: '2000 Ks' },
]
